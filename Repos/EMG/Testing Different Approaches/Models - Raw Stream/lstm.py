...
class EMGLSTM:
    ...
    def focal_loss(gamma=2.0, alpha=0.25):
        ...
        Down-weights easy examples so the model focuses on hard-to-classify
        samples.  *gamma* controls the focusing strength (0 = standard CE).
        *alpha* balances the importance of the positive class.
        """
    ...
    def build(self, max_seq_len, n_features=2, lstm_units=32, dropout=0.3,
              learning_rate=1e-3, focal_gamma=2.0, focal_alpha=0.25,
              verbose=False):
        ...
        focal_gamma : float
            Focusing parameter for focal loss (0 = standard BCE).
        focal_alpha : float
            Balancing factor for the positive class in focal loss.
        verbose : bool
